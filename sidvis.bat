...
ffmpeg -i "ch0.wav" -i "ch1.wav" -i "ch2.wav" -i "ch3.wav" -i "%tg0_1.wav%" -i "%tg0_2.wav%" -i "%tg0_3.wav%" -i "tg1.wav" -i "tg2.wav" -i "tg3.wav" -filter_complex ^"^
...
for /f "tokens=5 delims=- " %%V in ('ffmpeg -i "chn_trm_0dc_cct.wav" -af "volumedetect" -f null nul 2^>^&1 ^|find /i "max_volume"') do (
	ffmpeg -i "chn_trm_0dc_cct.wav" -i "all.wav" -filter_complex ^"^
