...
set "common_set=-f192000 -ols%track% -t%rec_time% --delay=%delay% -v%rec_clock%f -m%rec_model%f --fcurve=%rec_filter_curve% --frange=%o_filter_range% -cw%combined_waves% %q_sidplayfp%"
